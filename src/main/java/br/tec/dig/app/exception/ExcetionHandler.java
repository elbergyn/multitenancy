...
public class ExcetionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String mensagemUsuario = messageSource.getMessage("mensagem.parametroInvalido", null,
	...
	/*
	 * Erro de EmptyResultDataAccessException ao tentar apagar algo que não existe
	 * */
	...
	public ResponseEntity<Object> persistentObjectException(PersistentObjectException ex, WebRequest request) {
		String mensagemUsuario = messageSource.getMessage("recurso.detached", null,LocaleContextHolder.getLocale());
		String mensagemDesenvolvedor = ExceptionUtils.getRootCauseMessage(ex); 
	...
	/**
	 * Metodo que valida campos notnull 
	 */
	@Override
	...
	private List<Erro> criarListaErros(BindingResult bindResult){
		...
		for(FieldError field : bindResult.getFieldErrors()) {
